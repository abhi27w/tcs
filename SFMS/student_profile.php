...
<html lang = "en">
	<head>
		<title>TCS Inframind File Management System</title>
		<meta charset = "utf-8" />
...
<body>
	<nav class="navbar navbar-default navbar-fixed-top" style="background-color:blue;">
		<div class="container-fluid">
			<label class="navbar-brand" id="title">TCS inframind File Management System</label>
		</div>
	</nav>
	<div class="col-md-4">
		<?php
		...
		<div class="panel panel-default" style="background-color:#393f4d;" id="panel-margin">
			...
			<div class="panel-body">
				<h4 style="color:#fff;">User no: <label class="pull-right"><?php echo $fetch['stud_no']?></label></h4>
